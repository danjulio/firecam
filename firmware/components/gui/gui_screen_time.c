...
static void btn_set_time_keypad_callback(lv_obj_t * btn, lv_event_t event);
...
lv_obj_t* gui_screen_time_create()
{
	...
	lv_obj_set_style(time_screen, &lv_style_plain_color);
	
	// Create the graphical elements for this screen
	//
	// Screen Title
	lbl_time_title = lv_label_create(time_screen, NULL);
	lv_obj_set_pos(lbl_time_title, 110, 4);
	lv_obj_set_width(lbl_time_title, 100);
	lv_label_set_align(lbl_time_title, LV_LABEL_ALIGN_CENTER);
	lv_label_set_static_text(lbl_time_title, "Set Time/Date");
	
	// Set Time/Date String
	lbl_time_set = lv_label_create(time_screen, NULL);
	lv_obj_set_pos(lbl_time_set, 40, 30);
	lv_obj_set_width(lbl_time_set, 260);
	...
	const lv_style_t* lbl_time_set_style = lv_label_get_style(lbl_time_set, LV_LABEL_STYLE_MAIN);
	static lv_style_t lbl_time_set_new_style;
	lv_style_copy(&lbl_time_set_new_style, lbl_time_set_style);
	lbl_time_set_new_style.text.font = &lv_font_roboto_28;
	lbl_time_set_new_style.text.color = LV_COLOR_MAKE(0xD0, 0xD0, 0xD0);
	lv_label_set_style(lbl_time_set, LV_LABEL_STYLE_MAIN, &lbl_time_set_new_style);
	...
	lv_obj_set_pos(btn_set_time_keypad, 10, 80);
	lv_obj_set_width(btn_set_time_keypad, 300);
	lv_obj_set_height(btn_set_time_keypad, 160);
	...
	lv_obj_set_event_cb(btn_set_time_keypad, btn_set_time_keypad_callback);

	time_screen_active = false;
